...
class Ball {
  constructor(_) {
    this._ = _;
    this.pos = this._.createVector(this._.random(0, this._.width), this._.random(0, this._.height));
    this.w = Math.floor(this._.random(2, 12));
    this.vel = this._.createVector(this._.randomGaussian(0.75, -0.75), this._.randomGaussian(0.75, -0.75));
  }
